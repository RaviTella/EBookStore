package com.spring.cosmos.ebookstore.customer.cosmos;
...
public class StoreCosmosConfiguration extends AbstractCosmosConfiguration {
    ...
    protected String getDatabaseName() {
        return bookStoreConnectionProperties.getSecurityDatabase();
    }
    ...
    @EnableCosmosRepositories(basePackages = {"com.spring.cosmos.ebookstore.customer.model"})
